                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            {{-- LANGKAH 3: Tombol Export (Hanya muncul jika User adalah Admin) --}}
                            @can('export-product')
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <x-edit-button :url="route('product.edit', $product)" class="p-1.5 rounded-md text-gray-400 hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition" />
                                                <x-delete-button :url="route('product.delete', $product->id)" class="p-1.5 rounded-md text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition" />
                                            </div>
                                        </td>
                                    </tr>
                                @empty
