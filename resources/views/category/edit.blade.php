                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}" placeholder="Electronic"
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            <a href="{{ route('category.index') }}" class="px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                Cancel
                            </a>
